...
editInstallmentMaster = (data) => {
  ...
  this.setState({
    show: true,
     insertType:"single",
    title: 'Update InstallmentMaster',
    sessionName:data.InstallmentMasterName,
...
const data = await response.json();
 if(data.success){
   ...
   debugger
   this.setState({
         sessionList: data.InstallmentMasterData,
...
validateForm =()=>{
  ...
  manageInstallmentMaster = (e) => {
   ...
   if(this.state.isAdd){
    var data = {
        "InstallmentMasterName": this.state.sessionName
      }
      ...
      return this.state.sessionList.map((session, i) => {
        return (
          <tr>
            ...
            <td>{session.InstallmentMasterName}</td>
    ...
    return (
      ...
      <SideBar tabIndex='session'  shown='master' />
                          ...
                          <table class="table text-center">
                            <thead class="text-uppercase  bg-light-green">
                              <tr class="text-white">
                                ...
                                <th scope="col">InstallmentMaster Name</th>
		...
		<Modal show={this.state.show} backdrop="static" onHide={this.handleClose}>
            ...
            <div>
						<Col sm={4}> InstallmentMaster Name <small style={{color: 'red', fontSize: 18}}>*</small></Col>
						<Col sm={9}>
							<FormControl type="text" placeholder="InstallmentMaster Name like(2019-20)" value={this.state.sessionName} onChange={this.handleInputs} name="sessionName" />
