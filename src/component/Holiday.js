    ...
    .then(result=>{
      ...
      if(result.success){
        this.setState({courseId:"",chapterId:"", classId:""},()=>{
          this.getHoliday(this.state.current_page, this.state.per_page, this.state.searchStr);
        })
        toast.success(result.message,{
        })
       this.handleClose()
...
uploadFile=(e, type)=>{
  ...
  render() {
    return (
      ...
      <SideBar tabIndex='holiday'  shown='master' />
              ...
              <div className="row align-items-center">
                <div className="col-sm-6">
                  <div className="breadcrumbs-area clearfix">
                    <h4 className="page-title pull-left">Holiday</h4>
            ...
            <div class="main-content-inner">
              ...
              <ul className="filter-ul">
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div className="">
                        <h4 class="header-title">Holiday's List</h4>
                      ...
                      <div class="single-table">
                        <div class="table-responsive">
                          <table class="table text-center">
                            ...
                            <tbody>{this.showTest()}</tbody>


                          </table>
                          {this.state.holidayList.length == 0 && <p style={{ textAlign: "center" }}> No Record Found</p>}
                      ...
                      <span className={this.state.current_page=='1'?"disabled":""}
                        onClick={()=> {
                          if(this.state.current_page=='1'){
                            debugger
                            return;}
                          this.getHoliday(this.state.current_page-1, this.state.per_page, this.state.searchStr)
                        }}>Previous</span>
                      {this.state.holidayList.length > 0 && this.renderPageNumbers()}
